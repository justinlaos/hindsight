defmodule HistoraWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: HistoraWeb

      import Plug.Conn
      import HistoraWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {HistoraWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import HistoraWeb.ErrorHelpers
      import HistoraWeb.Gettext
      alias HistoraWeb.Router.Helpers, as: Routes
    end
  end
