defmodule HindsightWeb.Admin.SettingsController do
  ...
  def update(conn, %{"id" => id, "organization" => organization_params}) do
    ...
    case Organizations.update_organization(organization, organization_params) do
      {:ok, _organization} ->
        ...
        Hindsight.Data.event(conn.assigns.current_user, "Updated Organization Info")
        conn
  ...
  def create_customer_portal_session(conn, %{"id" => id}) do
    ...
    Hindsight.Data.page(conn.assigns.current_user, "Billing")
