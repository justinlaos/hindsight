defmodule HindsightWeb.TeamController do
  ...
  def index(conn, _params) do
    ...
    Hindsight.Data.page(conn.assigns.current_user, "Team Index")
  ...
  def create(conn, params) do
    ...
    case Teams.create_team(%{"private" => private, "name" => team["name"], "organization_id" => conn.assigns.organization.id}) do
      {:ok, team} ->
        ...
        Hindsight.Data.event(conn.assigns.current_user, "Created Team")
  ...
  def update(conn, %{"id" => id, "team" => team_params, "users_list" => users_list, "private" => private}) do
    ...
    case Teams.update_team(team, Map.merge(team_params, %{"private" => private})) do
      {:ok, team} ->
        ...
        Hindsight.Data.event(conn.assigns.current_user, "Updated Team")
  ...
  def delete(conn, %{"id" => id}) do
    ...
    Hindsight.Data.event(conn.assigns.current_user, "Deleted Team")
