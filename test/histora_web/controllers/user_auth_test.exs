defmodule HistoraWeb.UserAuthTest do
  use HistoraWeb.ConnCase, async: true

  alias Histora.Users
  alias HistoraWeb.UserAuth
  import Histora.UsersFixtures

  @remember_me_cookie "_histora_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HistoraWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HistoraWeb.Endpoint.subscribe(live_socket_id)
